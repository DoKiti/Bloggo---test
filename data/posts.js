    ...
    postsHTML += `
            <div class="post-container-preview">
                <div class="top-of-post-preview">
                      <div class="profile-picture-and-author-name-preview" data-user-container-id="${postDetails.authorId}">
                ...
                <div class="direct-to-post js-post-directory" data-post-directory-id="${postDetails.postId}">
